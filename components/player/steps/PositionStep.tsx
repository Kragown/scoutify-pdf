...
const POSITIONS_352: Record<string, { x: number; y: number; label: string }> = {
    ...
    "DCG": { x: 30, y: 75, label: "Défenseur Central Gauche" },
    "DC": { x: 50, y: 78, label: "Défenseur Central" },
    "DCD": { x: 70, y: 75, label: "Défenseur Central Droit" },
    "PG": { x: 15, y: 55, label: "Piston Gauche" },
    "MCG": { x: 35, y: 50, label: "Milieu Central Gauche" },
    "MC": { x: 50, y: 52, label: "Milieu Central" },
    "MCD": { x: 65, y: 50, label: "Milieu Central Droit" },
    "PD": { x: 85, y: 55, label: "Piston Droit" },
    "AT1": { x: 35, y: 20, label: "Attaquant" },
    "AT2": { x: 65, y: 20, label: "Attaquant" },
};
...
const POSITIONS_433: Record<string, { x: number; y: number; label: string }> = {
    ...
    "DCG": { x: 35, y: 78, label: "Défenseur Central Gauche" },
    "DCD": { x: 65, y: 78, label: "Défenseur Central Droit" },
    "DD": { x: 85, y: 75, label: "Défenseur Droit" },
    "MCG": { x: 30, y: 50, label: "Milieu Central Gauche" },
    "MC": { x: 50, y: 52, label: "Milieu Central" },
    "MCD": { x: 70, y: 50, label: "Milieu Central Droit" },
